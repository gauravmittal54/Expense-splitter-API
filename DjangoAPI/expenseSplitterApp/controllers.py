...
def create_user_controller(user_data):
    ...
    if existing_user:
        return {'error': 'User with this email already exists.'}, status.HTTP_400_BAD_REQUEST
    ...
    if user_serializer.is_valid():
        ...
        return user_serializer.data, status.HTTP_201_CREATED
    return user_serializer.errors, status.HTTP_400_BAD_REQUEST
